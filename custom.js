var VTTemplates = (function (pId) {
    ...
    templates.Results =
        [   '          <div class="vt-results">',
            ...
            '                    <img src="https://rawcdn.githack.com/bipashant/veritread/9b51fb/veritread/img/veritread-logo2.png" alt="VeriTread" class="vt-logo" /> Estimate',
            '                </div>',
    ...
    templates.LoadAdvisor =
        [  '<section class="vt-load-advisor vt-results-block" style="display:none;">',
            '  <ul class="vt-bullets">',
            '    <li class="vt-bullet" style="list-style-image: url(\'https://rawcdn.githack.com/bipashant/veritread/9b51fb/veritread/img/vt-bullet.png\');">Get Freight Specs and Instant Estimates</li>',
            '    <li class="vt-bullet" style="list-style-image: url(\'https://rawcdn.githack.com/bipashant/veritread/9b51fb/veritread/img/vt-bullet.png\');">Get Qualified Bids from Trustworthy Transporters</li>',
            '    <li class="vt-bullet" style="list-style-image: url(\'https://rawcdn.githack.com/bipashant/veritread/9b51fb/veritread/img/vt-bullet.png\');">Select a Transporter and Directly Communicate</li>',
            '  </ul>',
            '</section>'
        ];
    ...
    templates.HeaderDetailed =
        [  '<div class="vtbranding vt-header-2"><a href="http://www.veritread.com/" target="_blank">Get Accurate Freight Quotes &amp; Qualified Bids Using <img src="https://rawcdn.githack.com/bipashant/veritread/9b51fb/veritread/img/veritread-logo2.png" alt="VeriTread" class="vt-logo" /></a></div>'
        ];
    ...
    templates.Main =
        [   '  <form class="veritread-form{{extraFormClass}}">',
            ...
            '                          <span class="vt-dimensions-key vt-dimensions-key-local"><i class="vt-key-local" style="background-image: url(\'https://rawcdn.githack.com/bipashant/veritread/9b51fb/veritread/img/vt-dimensions.png\');"></i>{{localDimensionsLabel}}</span>',
            '                          <span class="vt-dimensions-key vt-dimensions-key-vt"><i class="vt-key-vt" style="background-image: url(\'https://rawcdn.githack.com/bipashant/veritread/9b51fb/veritread/img/vt-dimensions.png\');"></i>Base Model at time of manufacturing</span>',
            '                        </div>',
            ...
            '                              <span>Length</span> <i class="vt-dim-key" style="background-image: url(\'https://rawcdn.githack.com/bipashant/veritread/9b51fb/veritread/img/vt-dimensions.png\');"></i>',
            '                            </div>',
            '                            <div class="vt-type">',
            ...
            '                              <span>Width</span> <i class="vt-dim-key" style="background-image: url(\'https://rawcdn.githack.com/bipashant/veritread/9b51fb/veritread/img/vt-dimensions.png\');"></i>',
            '                            </div>',
            '                            <div class="vt-type">',
            ...
            '                              <span>Height</span> <i class="vt-dim-key" style="background-image: url(\'https://rawcdn.githack.com/bipashant/veritread/9b51fb/veritread/img/vt-dimensions.png\');"></i>',
            '                            </div>',
            '                            <div class="vt-type">',
            ...
            '                              <span>Attachment Width</span> <i class="vt-dim-key" style="background-image: url(\'https://rawcdn.githack.com/bipashant/veritread/9b51fb/veritread/img/vt-dimensions.png\');"></i>',
            '                            </div>',
            ...
            '                              <span>Angled Att. Width</span> <i class="vt-dim-key" style="background-image: url(\'https://rawcdn.githack.com/bipashant/veritread/9b51fb/veritread/img/vt-dimensions.png\');"></i>',
            '                            </div>',
            ...
            '                              <span>Weight</span> <i class="vt-dim-key" style="background-image: url(\'https://rawcdn.githack.com/bipashant/veritread/9b51fb/veritread/img/vt-dimensions.png\');"></i>',
            '                            </div>',
            '                            <div class="vt-type">',
            ...
            '                <div class="vt-average-pointer" id="vt-average-pointer" style="background: url(\'https://rawcdn.githack.com/bipashant/veritread/9b51fb/veritread/img/estimator-pointer-vert.png\') no-repeat;"></div>',
...
$(document).ready(function(){
    ...
    if(isListingPage()){
        addCalculateDeliveryFeeLabel();
    }

  function addCalculateDeliveryFeeLabel(){
       $("<div class='vtitem'></div><div class='veritread-triggering-link'><div class='listing-view-normal-link-'> <a class='icon-with-text-container' href='#'> <i class='ss-deliverytruck icon-part'></i><div class='text-part'>Get Delivery Fee</div></a></div></div>").insertBefore(".enabled-book-button");
       $(document).on("click", ".veritread-triggering-link" , function() {
           showPopup();
       });
   }
        ...
        var modalButtonOnly = new tingle.modal({
            ...
            onOpen: function(){
                var veritreadAppSettings = {
                        ...
                        assetsDir: 'veritread/',  // if not passed in, will default to 'veritread/'; sets path to dir with widget assets
                        ...
                        elementToUse: '.tingle-modal-box__content',
                ...
                veritread.addItemToElement('.tingle-modal-box__content', {
                    make: getMake(),
                    model: getModel(),
                    originCountryISO: 'US',
                    originPostal: address()//'33606' // You can specify your pickup location with country + postal code, or country + city, state/province
                });
            }
        });

        // modalButtonOnly.setContent($(".vtitem").html());

        modalButtonOnly.addFooterBtn('Close', 'tingle-btn tingle-btn--primary tingle-btn--pull-right hide', function(){
   ...
   function getMake(){
       var make = $("b:contains('Make')").parent().text().replace(/\s/g, '').replace("Make:", '');
       console.log(make);
       return make;
   }

   function getModel(){
       var model = $("b:contains('Model')").parent().text().replace(/\s/g, '').replace("Model:", '');
       console.log(model);
       return model;
   }

    function address(){
        return $('#origin_loc_address').val();
    }
    ...
    if( $("#video__How-Burly-helps-equipment-renters__3").length){
        $("#video__How-Burly-helps-equipment-renters__3").prepend('<h1 class="info__title--multi-column video-header-landing-page">For Equipment Renters</h1>');
    }
